...
/*2*/	IN::S,	IN::F, IN::T, IN::T, IN::T,	IN::T, IN::T, IN::S, IN::S,	IN::S, IN::O, IN::O, IN::S,	IN::O, IN::T, IN::O,\
/*3*/	IN::T,	IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T, IN::T,	IN::T, IN::T, IN::S, IN::T,	IN::O, IN::T, IN::T,\
